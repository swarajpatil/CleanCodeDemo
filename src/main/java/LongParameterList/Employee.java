...
public class Employee {
    ...
    public void incomeTax() {
        ...
        double tax = incomeTax.calculate(salary.getBasicSalary(), salary.getHRA(), salary.getTransportAllounce(), salary.getSpecialAllounce(),
                salary.getLTA(), salary.getMedicalAllounce(), investment.get80CInvestment(), investment.getinvestment80D());
        System.out.println(tax);
    }

    public boolean isBirthday(XDate xDate) {
        return false;
    }
